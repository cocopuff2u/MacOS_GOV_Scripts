...
####################################################################################################
#
# MacOS 15 (Sequoia) STIG Compliance Tool
#
...
#                                         History                                                  #
####################################################################################################
# Version 1.0 (08/21/24)
# - Based off (MacOS Sonoma STIG Tools/MacOS 14 Sonoma V2R1 STIG CHECKER.sh)
#
# Version 1.1 (08/27/24)
# - Corrected `initialize_logging` to write CSV header correctly
# - Fixed check for V-259427; the backslash was causing the check to fail
#
# Version 2.0 (10/29/24)
# - Updated to reflect new/removed STIGs
# - Combined check and fix scripts
# - Added getopts for command-line option parsing
...
# ==========================
STIG_VERSION="MACOS 15 (SEQUOIA) V1R1" # [ Do Not Adjust ]
...
#
# Example usage:
#   sudo bash path_to_script/MacOS_15_Sequoia_V1R1_STIG.sh -f

# ==========================
# Script Log Names
# ==========================
MANUAL_LOG_FILE_NAME="sequoia_stig_scan_manual_check.log"  # For logs that need manual checking
PASS_LOG_FILE_NAME="sequoia_stig_scan_passed.log"          # For passed checks
FAILURE_LOG_FILE_NAME="sequoia_stig_scan_failed.log"        # For failed checks
SINGLE_LOG_FILE_NAME="sequoia_stig_scan_summary.log"        # For a summary of both passed and failed checks
COMMAND_LOG_FILE_NAME="sequoia_stig_scan_command_output.log" # For output of the commands executed
CSV_LOG_FILE_NAME="sequoia_stig_scan_results_combined.csv"  # For a combined CSV of results
...
# ==========================
Apple_Only_Checks=("APPL-15-002220" "APPL-15-005120") # Example: Apple_Only_Checks=("APPL-15-002052" "APPL-15-002051")
Intel_Only_Checks=("APPL-15-002230" "APPL-15-003013") # Example: Intel_Only_Checks=("APPL-15-002052" "APPL-15-002051")
...
#
# check_name="APPL-15-000024"                         # STIG ID
